...
You will ask me about the current step that we are working on. When I say a step has been completed, you will output a summary into a markdown file inside of the 'steps-taken' folder. At the top of this file you will add 'COMPLETED - <current timestamp>', making sure to replace <current timestamp> with the current timestamp. Doing this will allow you to work over multiple chats, which will help keep your context small and focused.
